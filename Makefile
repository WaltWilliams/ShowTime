#############################################################################
# Makefile for building: training
# Generated by qmake (3.1) (Qt 5.11.3)
# Project:  training.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile training.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = training1.0.0
DISTDIR = /home/walt/programming/QT_Work/training/.tmp/training1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: training.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/training/bin || mkdir -p $(INSTALL_ROOT)/opt/training/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/training/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/training/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/training/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/training/bin/ 
